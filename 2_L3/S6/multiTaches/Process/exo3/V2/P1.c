...
int main(int argc, char *argv[]) {
  ...
  */
  ...
  /* //Est le premier a devoir être éxécuter, commence sans demande.
  ...
  */
  ...
  while (dejaTraite < nombre_zones) {
    attachement[dejaTraite] += dejaTraite;
  ...
  cout << pid << " débute le traitement Globale" << endl;
    ...
    attachementGlobale[0] += 1;
    cout << "Nombres de zone traité par P1 mise à jour à " << attachement[0] << endl;
